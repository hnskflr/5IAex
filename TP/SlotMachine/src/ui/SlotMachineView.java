...
{
	public static SlotMachineView INSTANCE;
	...
	/** Label for slot 1 */
	private static JLabel slot1;
	/** Label for slot 2 */
	private static JLabel slot2;
	/** Label for slot 3 */
	private static JLabel slot3;
	 ...
	 */
	public static void setImages(Image image1, Image image2, Image image3) {
		// Set the new images
		if (image1 != null)
